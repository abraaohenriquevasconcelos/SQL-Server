...
--sus.objects.object_id                  -> nesse contexto é o ID de uma tabela	
--sys.indexes.object_id                  -> ID do objeto ao qual este índice pertence (Tabela)
--sys.key_constraints.parent_object_id   -> ID do objeto ao qual este objeto pertence. (0 = Não é um objeto filho.)
--sys.key_constraints.unique_index_id    -> ID do índice exclusivo correspondente no objeto pai que foi criado para impor esta restrição.
...
where is_unique = 1 --1 = O índice é exclusivo / 0 = O índice não é exclusivo.
